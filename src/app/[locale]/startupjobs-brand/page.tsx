...
/**
 * /startupjobs-brand — Brand-Manual variant.
 * Struktura, komponenty, animace, marquee, sticky CTA = 1:1 stejné jako
 * /startupjobs. Jediný rozdíl: extra `.bh-scope` třída, která re-mapuje
 * CSS tokens (--color-purple-deep, --font-fraunces, --sj-signal-green, …)
 * na hodnoty z Behavera Brand Manuálu (NIVA). Žádná sekce se neupravuje.
 */

const BASE_URL = "https://www.behavera.com";
const PHONE = "+420 605 839 456";
const EMAIL = "hello@behavera.com";
const PATH = "/startupjobs-brand";
...
export default async function StartupJobsBrandPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <div
      className="sj-body sj-scope bh-scope"
