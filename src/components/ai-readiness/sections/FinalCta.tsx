...
const bullets: { tag: string; body: string }[] = [
  {
    ...
    body: "Řekněte nám, kde jste s AI dnes — a kde to drhne. Z hovoru odejdete s pojmenováním 2–3 míst, kde dnes nemáte visibility, a doporučením, kde začít.",
  },
  {
    tag: "CO Z TOHO MÁTE",
    body: "Konkrétní výstup, ne generická prezentace. Pokud AI Readiness Suite u vás dnes nedává smysl, řekneme to rovnou — a kam jít místo toho.",
  },
];
...
export default function FinalCta() {
  return (
    <section
      id="consult"
      className="sj-grain sj-grain-dark sj-reveal sj-on-dark scroll-mt-[140px] lg:scroll-mt-[160px]"
      style={{
      ...
      <div className="max-w-[1240px] mx-auto px-6 md:px-10 py-24 md:py-32">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            <span className="sj-section-anchor">08 · Začněte</span>
            <h2 className="sj-h-manifesto mt-6 max-w-[14ch]" style={{ fontSize: "clamp(44px, 6.4vw, 76px)" }}>
              15 minut.{" "}
              <em>Nula obchodního tlaku.</em>
            </h2>
            <p
              className="mt-8 max-w-[46ch] leading-[1.6]"
              style={{ fontSize: 18, color: "rgba(255,255,255,0.78)" }}
            >
              <span className="sj-hl-on-dark">Žádný obchodní tlak</span> —
              projdeme váš AI kontext a řekneme, kde Behavera dnes dává smysl, a
              kde ne.
            </p>
